...
<div class="page-title" style="margin-bottom: 2rem;">
    ...
    <p>Kelola semua attraction wisata Anda di sini</p>
</div>
        ...
        <table>
            ...
            <tbody>
                @forelse ($attractions as $attraction)
                    <tr>
                        <td>
                            <span class="id-badge">{{ $attraction->id }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <small>{{ Str::limit($attraction->description ?? 'Tidak ada deskripsi', 60) }}</small>
                        </td>
                        <td style="text-align: center;">
                            <div style="display: flex; gap: 6px; justify-content: center; flex-wrap: wrap;">
                                ...
                                <a 
                                    href="{{ route('attractions.edit', $attraction->id) }}" 
                                ...
                                <form 
                                    action="{{ route('attractions.delete', $attraction->id) }}" 
                                    method="POST" 
                                    style="display: inline-block;"
                                    onsubmit="return confirm('Yakin ingin menghapus {{ $attraction->name }}?')"
                                >
                                    @csrf
                                    @method('DELETE')
                                    <button 
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center; padding: 2rem;">
                            <div style="color: var(--text-muted);">
                                ...
                                <p>Tidak ada attraction yang ditemukan</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
